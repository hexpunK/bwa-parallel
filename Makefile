...
MAKECFLAGS=		-Wall -Wno-unused-function -L/tgac/software/testing/libraries/zlib/1.2.8/x86_64/lib/ -lz
WRAP_MALLOC=-DUSE_MALLOC_WRAPPERS
AR=			ar
DFLAGS=		-DHAVE_PTHREAD $(WRAP_MALLOC)
MAKELOBJS=		utils.o kthread.o kstring.o ksw.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o
MAKEAOBJS=		QSufSort.o bwt_gen.o bwashm.o bwase.o bwaseqio.o bwtgap.o bwtaln.o bamlite.o \
			is.o bwtindex.o bwape.o kopen.o pemerge.o \
			bwtsw2_core.o bwtsw2_main.o bwtsw2_aux.o bwt_lite.o \
			bwtsw2_chain.o fastmap.o bwtsw2_pair.o
PROG=		bwa
MAKEINCLUDES=	-I/tgac/software/testing/libraries/zlib/1.2.8/x86_64/include/	
MAKELIBS=		-lm -lz -lpthread
SUBDIRS=	.
...
.c.o:
		$(CC) -c $(CFLAGS) $(MAKECFLAGS) $(DFLAGS) $(MAKEINCLUDES) $(INCLUDES) $< -o $@

all:$(PROG)

bwa:libbwa.a $(MAKEAOBJS) $(AOBJS) main.o
		$(CC) $(CFLAGS) $(MAKECFLAGS) $(DFLAGS) $(AOBJS) $(MAKEAOBJS) main.o -o $@ -L. -lbwa $(LIBS) $(MAKELIBS)

bwamem-lite:libbwa.a example.o
		$(CC) $(CFLAGS) $(MAKECFLAGS) $(DFLAGS) example.o -o $@ -L. -lbwa $(LIBS) $(MAKELIBS)

libbwa.a:$(MAKELOBJS) $(LOBJS)
		$(AR) -csru $@ $(LOBJS) $(MAKELOBJS)

clean:
		rm -f gmon.out *.o a.out $(PROG) *~ *.a

depend:
	( LC_ALL=C ; export LC_ALL; makedepend -Y -- $(CFLAGS) $(MAKECFLAGS) $(DFLAGS) -- *.c )
